# Decompile by Sabbir Hasan(Tools By Toxic Sabbir)
# Dont ader restiment with Sabbir
# Decode file /- Toxic Sabbir PYC 3.11
# DECODE FILE VERSION - V.3.1.1
# WHATSAPP - +8801705795071
import os
import time
os.system("clear")
print("  ==> \033[1;32mTHIS TOOLS DECODE BY (Toxic Sabbir) ")
time.sleep(5)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://raw.githubusercontent.com/sabbir-hasan-2/OldCrack/main/Premium.txt"])
	exit(" [*] TELEGRAM : https://t.me/sabbir-hasan-2 ")
...
def notice():
	...
	runtxt("\033[0;92m BYPASS ADMIN TELEGRAM >> https://t.me/sabbir-hasan-2")
	runtxt("\033[0;95m    <===================☠️  \033[0;97mEXIT\033[0;95m ☠️===================> ")
	subprocess.check_output(["am", "start", "https://t.me/sabbir-hasan-2"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://raw.githubusercontent.com/sabbir-hasan-2/OldCrack/main/Premium.txt').text
			if basesplit in plr:
				key = basesplit
		...
		print("\n"+C+"░█████╗░██████╗░██╗██████╗░\n██╔══██╗██╔══██╗██║██╔══██╗ "+Y+"|Sabbir"+C+"\n███████║██████╦╝██║██████╔╝ "+Y+"|Hasan"+C+"\n██╔══██║██╔══██╗██║██╔══██╗ "+Y+"|Ratul"+C+"\n██║░░██║██████╦╝██║██║░░██║\n╚═╝░░╚═╝╚═════╝░╚═╝╚═╝░░╚═╝\n "+N+"──────────────────────────────────────────────────"+G+"\n▸ AUTHOR     : Toxic Sabbir \n▸ FACEBOOK   : https://www.facebook.com/toxicsabbir2\n▸ YOUTUBE    : https://youtube.com/channel/UCRbqkVpKQ7Gh1o3vVXeisZg\n▸ GITHUB     : https://github.com/Sabbir-hasan-2\n"+N+"─────────────────────────────────────────────────\n")
		...
		runtxt("\n    \033[0;92m <=======    Sabbir 𝐈𝐃 𝐂𝐋𝐎𝐍𝐄𝐑    =======>  \033[0;97m ")
